...
const Testimonial = ({ name, text, image, bussiness, currentTestimonial }) => {
    ...
    return (
        <li className="bg-dark-custom text-white h-[80%] p-4 mt-7 lg:ml-20 ml-14 lg:mr-[20%] lg:w-[80%] w-[100%] shrink-0 relative shadow-[4px_4px_10px_0px_rgba(0,0,0,0.4)] transition-transform ease-out duration-500" style={{transform : `translateX(-${currentTestimonial*135}%)`}}>
